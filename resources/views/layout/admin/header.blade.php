...
<head>
  ...
  <link rel="stylesheet" href="{{asset('public/admin')}}/plugins/fontawesome-free/css/all.6.1.2.min.css"/>
  <!-- Font Bootstrap Icons -->
  <link rel="stylesheet" href="{{asset('public/admin')}}/plugins/bootstrap/bootstrap-icons.css">
  <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{asset('public/admin')}}/dist/img/preloader.png" alt="AdminLTELogo">
  </div>